...
<body>
  ...
  <form action="insert.php" method="post">
    <div>
      ...
      <input type="email" id="user_email" name="user_email" maxlength="60" required>

      <label for="user_age">年齢</label>
      <input type="number" id="user_age" name="user_age" maxlength="60" required>

      <label for="user_address">住所</label>
      <input type="text" id="user_address" name="user_address" maxlength="60" required>
    </div>
